...
spec = do
  ...
  jsonSchemaSpec @(Map Text Int) "map-text-int"
  jsonSchemaSpec @(Int, Int) "tuple-int-int"
  jsonSchemaSpec @(Text, Int) "tuple-text-int"
  jsonSchemaSpec @(Text, Int, Bool) "triple-text-int-bool"
